// /api/pay - Vercel serverless endpoint
// Receives { amount, phone, purpose, userPhone }
// Initiates PayHero STK and writes payment record to Firebase RTDB
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const callbackUrl = `${publicBase}/api/payment-callback?pid=${paymentId}`;
